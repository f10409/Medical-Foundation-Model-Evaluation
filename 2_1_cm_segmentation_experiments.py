...
def main():
    ...
    parser = argparse.ArgumentParser(description='Run cardiomegaly segmentation experiments')
    ...
    experiments = [
        {
            ...
            'test_name': f'SegFormer_cm_seg_e2e_{FOLD}',
            'GPU': GPU_NUM,
            'img_size': 512,  #raddino:518, medsiglip:448, siglip2:512, chexagent:512, biomedclip:224
            'patch_size': None, #raddino:14, medsiglip:14, siglip2:16, chexagent:16, biomedclip:16
            'n_channel': None #raddino:768, medsiglip:1152, siglip2:1152, chexagent:1024, biomedclip:512/768
        },
        # {
        #     'model_name': "google/medsiglip-448",
        #     'freeze_encoder': True,
        #     'test_name': f'MedSigLIP_cm_seg_fz_{FOLD}',
        #     'GPU': GPU_NUM,
        #     'img_size': 448,  #raddino:518, medsiglip:448, siglip2:512, chexagent:512, biomedclip:224
        #     'patch_size': 14, #raddino:14, medsiglip:14, siglip2:16, chexagent:16, biomedclip:16
        #     'n_channel': 1152 #raddino:768, medsiglip:1152, siglip2:1152, chexagent:1024, biomedclip:512/768
        # },
        # {
        #     'model_name': "google/medsiglip-448",
        #     'freeze_encoder': False,
        #     'test_name': f'MedSigLIP_cm_seg_e2e_{FOLD}',
        #     'GPU': GPU_NUM,
        #     'img_size': 448,  #raddino:518, medsiglip:448, siglip2:512, chexagent:512, biomedclip:224
        #     'patch_size': 14, #raddino:14, medsiglip:14, siglip2:16, chexagent:16, biomedclip:16
        #     'n_channel': 1152 #raddino:768, medsiglip:1152, siglip2:1152, chexagent:1024, biomedclip:512/768
        ...
        #     'freeze_encoder': True,
        #     'test_name': f'CheXagent_cm_seg_fz_{FOLD}',
        #     'GPU': GPU_NUM,
        #     'img_size': 512,  #raddino:518, medsiglip:448, siglip2:512, chexagent:512, biomedclip:224
        #     'patch_size': 16, #raddino:14, medsiglip:14, siglip2:16, chexagent:16, biomedclip:16
        #     'n_channel': 1024 #raddino:768, medsiglip:1152, siglip2:1152, chexagent:1024, biomedclip:512/768
        # },
        # {
        #     'model_name': "StanfordAIMI/XraySigLIP__vit-l-16-siglip-384__webli",
        #     'freeze_encoder': False,
        #     'test_name': f'CheXagent_cm_seg_e2e_{FOLD}',
        #     'GPU': GPU_NUM,
        #     'img_size': 512,  #raddino:518, medsiglip:448, siglip2:512, chexagent:512, biomedclip:224
        #     'patch_size': 16, #raddino:14, medsiglip:14, siglip2:16, chexagent:16, biomedclip:16
        #     'n_channel': 1024 #raddino:768, medsiglip:1152, siglip2:1152, chexagent:1024, biomedclip:512/768
        ...
        #     'freeze_encoder': True,
        #     'test_name': f'BiomedCLIP_cm_seg_fz_{FOLD}',
        #     'GPU': GPU_NUM,
        #     'img_size': 224,  #raddino:518, medsiglip:448, siglip2:512, chexagent:512, biomedclip:224
        #     'patch_size': 16, #raddino:14, medsiglip:14, siglip2:16, chexagent:16, biomedclip:16
        ...
        #     'model_name': "hf-hub:microsoft/BiomedCLIP-PubMedBERT_256-vit_base_patch16_224",
        #     'freeze_encoder': False,
        #     'test_name': f'BiomedCLIP_cm_seg_e2e_{FOLD}',
        #     'GPU': GPU_NUM,
        #     'img_size': 224,  #raddino:518, medsiglip:448, siglip2:512, chexagent:512, biomedclip:224
        #     'patch_size': 16, #raddino:14, medsiglip:14, siglip2:16, chexagent:16, biomedclip:16
        #     'n_channel': 768  #raddino:768, medsiglip:1152, siglip2:1152, chexagent:1024, biomedclip:512/768
        ...
        #     'freeze_encoder': True,
        #     'test_name': f'RAD-DINO_cm_seg_fz_{FOLD}',
        #     'GPU': GPU_NUM,
        #     'img_size': 518,  #raddino:518, medsiglip:448, siglip2:512, chexagent:512, biomedclip:224
        #     'patch_size': 14, #raddino:14, medsiglip:14, siglip2:16, chexagent:16, biomedclip:16
        #     'n_channel': 768  #raddino:768, medsiglip:1152, siglip2:1152, chexagent:1024, biomedclip:512/768
        # },
        # {
        #     'model_name': "microsoft/rad-dino",
        #     'freeze_encoder': False,
        #     'test_name': f'RAD-DINO_cm_seg_e2e_{FOLD}',
        #     'GPU': GPU_NUM,
        #     'img_size': 518,  #raddino:518, medsiglip:448, siglip2:512, chexagent:512, biomedclip:224
        #     'patch_size': 14, #raddino:14, medsiglip:14, siglip2:16, chexagent:16, biomedclip:16
        #     'n_channel': 768  #raddino:768, medsiglip:1152, siglip2:1152, chexagent:1024, biomedclip:512/768
        ...
        #     'freeze_encoder': True,
        #     'test_name': f'SigLIP2_cm_seg_fz_{FOLD}',
        #     'GPU': GPU_NUM,
        #     'img_size': 512,  #raddino:518, medsiglip:448, siglip2:512, chexagent:512, biomedclip:224
        #     'patch_size': 16, #raddino:14, medsiglip:14, siglip2:16, chexagent:16, biomedclip:16
        #     'n_channel': 1152 #raddino:768, medsiglip:1152, siglip2:1152, chexagent:1024, biomedclip:512/768
        ...
        #     'model_name': "google/siglip2-so400m-patch16-512",
        #     'freeze_encoder': False,
        #     'test_name': f'SigLIP2_cm_seg_e2e_{FOLD}',
        #     'GPU': GPU_NUM,
        #     'img_size': 512,  #raddino:518, medsiglip:448, siglip2:512, chexagent:512, biomedclip:224
        #     'patch_size': 16, #raddino:14, medsiglip:14, siglip2:16, chexagent:16, biomedclip:16
        #     'n_channel': 1152 #raddino:768, medsiglip:1152, siglip2:1152, chexagent:1024, biomedclip:512/768
        ...
        #     'freeze_encoder': True,
        #     'test_name': f'DINOv2_cm_seg_fz_{FOLD}',
        #     'GPU': GPU_NUM,
        #     'img_size': 224,  #raddino:518, medsiglip:448, siglip2:512, chexagent:512, biomedclip:224
        #     'patch_size': 14, #raddino:14, medsiglip:14, siglip2:16, chexagent:16, biomedclip:16
        #     'n_channel': 768  #raddino:768, medsiglip:1152, siglip2:1152, chexagent:1024, biomedclip:512/768
        ...
        #     'model_name': "facebook/dinov2-base",
        #     'freeze_encoder': False,
        #     'test_name': f'DINOv2_cm_seg_e2e_{FOLD}',
        #     'GPU': GPU_NUM,
        #     'img_size': 224,  #raddino:518, medsiglip:448, siglip2:512, chexagent:512, biomedclip:224
        #     'patch_size': 14, #raddino:14, medsiglip:14, siglip2:16, chexagent:16, biomedclip:16
        #     'n_channel': 768  #raddino:768, medsiglip:1152, siglip2:1152, chexagent:1024, biomedclip:512/768
...
from utils.fine_tune_segmentation_model import fine_tune_segmentation_model
from utils.evaluate_segmentation_model import evaluate_segmentation_model
from config_cm_seg import config
...
config.input_path = "./inputs/input_train_cm_cla_{FOLD}.csv"
...
predictions_df['target'] = "cardiomegaly"
