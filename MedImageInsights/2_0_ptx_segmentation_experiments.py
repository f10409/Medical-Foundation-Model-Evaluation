    ...
    experiments = [
        {
            ...
            'freeze_encoder': True,
            'test_name': f'MedImageInsights(16)_ptx_seg_fz_{FOLD}',
            'GPU': GPU_NUM,
        ...
        },
        {
            ...
            'test_name': f'MedImageInsights(16)_ptx_seg_e2e_{FOLD}',
            'GPU': GPU_NUM,
            'img_size': 480,  #raddino:518, medsiglip:448, siglip2:512, chexagent:512, biomedclip:224
            'patch_size': 16, #raddino:14, medsiglip:14, siglip2:16, chexagent:16, biomedclip:16
            'n_channel': 1024  #raddino:768, medsiglip:1152, siglip2:1152, chexagent:1024, biomedclip:512/768
        },
        {
            'model_name': "MedImageInsights",
            'freeze_encoder': True,
            'test_name': f'MedImageInsights(32)_ptx_seg_fz_{FOLD}',
            'GPU': GPU_NUM,
            'img_size': 480,  #raddino:518, medsiglip:448, siglip2:512, chexagent:512, biomedclip:224
        ...
        },
        {
            'model_name': "MedImageInsights",
            'freeze_encoder': False,
            'test_name': f'MedImageInsights(32)_ptx_seg_e2e_{FOLD}',
            'GPU': GPU_NUM,
            'img_size': 480,  #raddino:518, medsiglip:448, siglip2:512, chexagent:512, biomedclip:224
            'patch_size': 32, #raddino:14, medsiglip:14, siglip2:16, chexagent:16, biomedclip:16
            'n_channel': 2048  #raddino:768, medsiglip:1152, siglip2:1152, chexagent:1024, biomedclip:512/768
