...
class config:
    ...
    # Data Configuration
    # ========================
    img_base_path = '/mnt/NAS3/datasets/internal/EmoryCXRv2/CheXmask/CheXmask-v1 0/Preprocessed/'  # Base path for images
    msk_base_path = '/mnt/NAS3/datasets/internal/EmoryCXRv2/CheXmask/CheXmask_Masks/'  # Base path for masks
    input_path = 'input_train_cm_cla.csv'    # Input dataset CSV path
    mask_suffix = 'mask'
    IMG_PATH_COLUMN_NAME = 'SOP'
