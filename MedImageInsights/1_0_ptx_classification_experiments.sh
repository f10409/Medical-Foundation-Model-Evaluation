...
nohup python 1_0_ptx_classification_experiments.py --gpu_num 3 --fold 1 > ./outs/ptx_classification1.out 2>&1 &
PID2=$!

nohup python 1_0_ptx_classification_experiments.py --gpu_num 5 --fold 2 > ./outs/ptx_classification2.out 2>&1 &
PID3=$!

nohup python 1_0_ptx_classification_experiments.py --gpu_num 6 --fold 3 > ./outs/ptx_classification3.out 2>&1 &
PID4=$!

nohup python 1_0_ptx_classification_experiments.py --gpu_num 7 --fold 4 > ./outs/ptx_classification4.out 2>&1 &
PID5=$!
