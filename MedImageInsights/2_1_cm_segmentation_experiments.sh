...
nohup python 2_1_cm_segmentation_experiments.py --gpu_num 3 --fold 1 > ./outs/cm_segmentation1.out 2>&1 &
PID2=$!

nohup python 2_1_cm_segmentation_experiments.py --gpu_num 5 --fold 2 > ./outs/cm_segmentation2.out 2>&1 &
PID3=$!

nohup python 2_1_cm_segmentation_experiments.py --gpu_num 6 --fold 3 > ./outs/cm_segmentation3.out 2>&1 &
PID4=$!

nohup python 2_1_cm_segmentation_experiments.py --gpu_num 4 --fold 4 > ./outs/cm_segmentation4.out 2>&1 &
PID5=$!
