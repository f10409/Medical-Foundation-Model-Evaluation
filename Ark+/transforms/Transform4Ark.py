...
class ArkProcessor(MapTransform):

    def __init__(self, keys: KeysCollection, image_size: int = 768):
        super().__init__(keys)
    ...
    def __call__(self, data):
        ...
        for key in self.keys:
            ...
            transform = self.eval_preprocessing()
