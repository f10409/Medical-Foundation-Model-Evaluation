...
class config:
    ...
    # Label Configuration  
    # ========================
    labels = ['Cardiomegaly']  # List of class labels. ex: ['No Finding', 'Pneumothorax']
    ...
    # Data Configuration
    # ========================
    img_base_path = '/mnt/NAS3/datasets/internal/EmoryCXRv2/ORIGINAL_PNG/'  # Base path for images
