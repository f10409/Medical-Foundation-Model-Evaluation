...
class FMClassifier(pl.LightningModule):
    ...
    def __init__(self, config):
        ...
        #     self.embed_dim = 1024
        #     self.proj = classifier.model.image_projection
    ...
    def forward(self, pixel_values):
        ...
        #     vision_outputs = torch.matmul(vision_outputs, self.proj) #vision_outputs@self.proj
        #     pooled_output = vision_outputs / vision_outputs.norm(dim=-1, keepdim=True)   
    ...
    def configure_optimizers(self):
        ...
        if not self.freeze_encoder:
            ...
            param_groups = [
                ...
                # {
                # 'params': [self.proj],  # Single parameter in a list
                # 'lr': encoder_lr,
                # 'name': 'projection'
                # },
                {
