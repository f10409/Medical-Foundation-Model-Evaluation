...
def main():
    ...
    experiments = [

        {
            'model_name': "Ark+",
            'freeze_encoder': True,
            'test_name': f'Ark+_ptx_cla_fz_{FOLD}',
            'GPU': GPU_NUM
        },
        {
            'model_name': "Ark+",
            'freeze_encoder': False,
            'test_name': f'Ark+_ptx_cla_e2e_{FOLD}',
            'GPU': GPU_NUM
        },
        # {
        #     'model_name': "MedImageInsights",
        #     'freeze_encoder': True,
        #     'test_name': f'MedImageInsights_ptx_cla_fz_{FOLD}',
        #     'GPU': GPU_NUM
        # },
        # {
        #     'model_name': "MedImageInsights",
        #     'freeze_encoder': False,
        #     'test_name': f'MedImageInsights_ptx_cla_e2e_{FOLD}',
        #     'GPU': GPU_NUM
        # },
        # {
