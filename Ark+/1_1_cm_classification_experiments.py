...
def main():
    ...
    parser = argparse.ArgumentParser(description='Run cardiomegaly classification experiments')
    ...
    experiments = [
        {
            'model_name': "Ark+",
            'freeze_encoder': True,
            'test_name': f'Ark+_cm_cla_fz_{FOLD}',
            'GPU': GPU_NUM
        },
        {
            'model_name': "Ark+",
            'freeze_encoder': False,
            'test_name': f'Ark+_cm_cla_e2e_{FOLD}',
            'GPU': GPU_NUM
        },
        # {
        #     'model_name': "MedImageInsights",
        #     'freeze_encoder': True,
        #     'test_name': f'MedImageInsights_cm_cla_fz_{FOLD}',
        #     'GPU': GPU_NUM
        # },
        # {
        #     'model_name': "MedImageInsights",
        #     'freeze_encoder': False,
        #     'test_name': f'MedImageInsights_cm_cla_e2e_{FOLD}',
        #     'GPU': GPU_NUM
        # },
        # {
        #     'model_name': "google/medsiglip-448",
        #     'freeze_encoder': True,
        #     'test_name': f'MedSigLIP_cm_cla_fz_{FOLD}',
        #     'GPU': GPU_NUM
        # },
        # {
        #     'model_name': "google/medsiglip-448",
        #     'freeze_encoder': False,
        #     'test_name': f'MedSigLIP_cm_cla_e2e_{FOLD}',
        #     'GPU': GPU_NUM
        # },
        # {
        #     'model_name': "StanfordAIMI/XraySigLIP__vit-l-16-siglip-384__webli",
        #     'freeze_encoder': True,
        #     'test_name': f'CheXagent_cm_cla_fz_{FOLD}',
        #     'GPU': GPU_NUM
        # },
        # {
        #     'model_name': "StanfordAIMI/XraySigLIP__vit-l-16-siglip-384__webli",
        #     'freeze_encoder': False,
        #     'test_name': f'CheXagent_cm_cla_e2e_{FOLD}',
        #     'GPU': GPU_NUM
        # },
        # {
        #     'model_name': "hf-hub:microsoft/BiomedCLIP-PubMedBERT_256-vit_base_patch16_224",
        #     'freeze_encoder': True,
        #     'test_name': f'BiomedCLIP_cm_cla_fz_{FOLD}',
        #     'GPU': GPU_NUM
        # },
        # {
        #     'model_name': "hf-hub:microsoft/BiomedCLIP-PubMedBERT_256-vit_base_patch16_224",
        #     'freeze_encoder': False,
        #     'test_name': f'BiomedCLIP_cm_cla_e2e_{FOLD}',
        #     'GPU': GPU_NUM
        # },
        # {
        #     'model_name': "microsoft/rad-dino",
        #     'freeze_encoder': True,
        #     'test_name': f'RAD-DINO_cm_cla_fz_{FOLD}',
        #     'GPU': GPU_NUM
        # },
        # {
        #     'model_name': "microsoft/rad-dino",
        #     'freeze_encoder': False,
        #     'test_name': f'RAD-DINO_cm_cla_e2e_{FOLD}',
        #     'GPU': GPU_NUM
        # },
        # {
        #     'model_name': "google/siglip2-so400m-patch16-512",
        #     'freeze_encoder': True,
        #     'test_name': f'SigLIP2_cm_cla_fz_{FOLD}',
        #     'GPU': GPU_NUM
        # },
        # {
        #     'model_name': "google/siglip2-so400m-patch16-512",
        #     'freeze_encoder': False,
        #     'test_name': f'SigLIP2_cm_cla_e2e_{FOLD}',
        #     'GPU': GPU_NUM
        # },
        # {
        #     'model_name': "facebook/dinov2-base",
        #     'freeze_encoder': True,
        #     'test_name': f'DINOv2_cm_cla_fz_{FOLD}',
        #     'GPU': GPU_NUM
        # },
        # {
        #     'model_name': "facebook/dinov2-base",
        #     'freeze_encoder': False,
        #     'test_name': f'DINOv2_cm_cla_e2e_{FOLD}',
        #     'GPU': GPU_NUM
        # }
    ]
...
from utils.fine_tune_classification_model import fine_tune_classification_model
from utils.evaluate_classification_model import evaluate_classification_model
from config_cm_cla import config
