import torch
import numpy as np
from monai.transforms import Transform, MapTransform, Resize
from monai.config import KeysCollection
from transformers import AutoImageProcessor
from PIL import Image
import monai as mn
from typing import Any, Dict, Optional, Hashable, Mapping

class DINOProcessor(MapTransform):
    """
    ...
    Args:
        ...
        im_size (int): Target image size (both height and width) after processing.
            Default: 518
    """
    def __init__(self, keys: KeysCollection, processor_name: str = "facebook/dinov2-base"):
        super().__init__(keys)
