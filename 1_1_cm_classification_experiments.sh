...
nohup python 1_1_cm_classification_experiments.py --gpu_num 2 --fold 1 > ./outs/cm_classification1.out 2>&1 &
PID2=$!

nohup python 1_1_cm_classification_experiments.py --gpu_num 3 --fold 2 > ./outs/cm_classification2.out 2>&1 &
PID3=$!

nohup python 1_1_cm_classification_experiments.py --gpu_num 6 --fold 3 > ./outs/cm_classification3.out 2>&1 &
PID4=$!

nohup python 1_1_cm_classification_experiments.py --gpu_num 5 --fold 4 > ./outs/cm_classification4.out 2>&1 &
PID5=$!
